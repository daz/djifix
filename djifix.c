...
static char const* versionStr = "2025-04-03";
  ...
  */
  {
    ...
    */
    while (1) {
      ...
      fprintf(stderr, "\tIf the video format was H.265, 1080p, 60fps: Type C, then the \"Return\" key.\n");
      fprintf(stderr, "\tIf the video format was H.265, 1080p, 50fps: Type D, then the \"Return\" key.\n");
      fprintf(stderr, "\tIf the video format was H.264, 1080p, 48fps: Type E, then the \"Return\" key.\n");
      ...
      fprintf(stderr, "\tIf the video format was H.264, 720p, 30fps: Type H, then the \"Return\" key.\n");
      fprintf(stderr, "\tIf the video format was H.264, 720p, 24fps: Type I, then the \"Return\" key.\n");
      fprintf(stderr, " If the resulting file is unplayable by VLC or IINA, then you may have guessed the wrong format;\n");
      fprintf(stderr, " try again with another format.)\n");
      fprintf(stderr, "If you know for sure that your video format was *not* one of the ones listed above, then please read FAQ number 4 at \"https://djifix.live555.com/#faq\", and we'll try to update the software to support your video format.\n");
      do {formatCode = getchar(); } while (formatCode == '\r' && formatCode == '\n');
    ...
    switch (formatCode) {
      ...
      case '8': { sps = type5_H265_SPS_2160p24; pps = type5_H265_PPS_2160p24; vps = type5_H265_VPS_2160p_default; break; }
      ...
      case 'c': case 'C': { sps = type5_H265_SPS_1080p60; pps = type5_H265_PPS_1080p60; vps = type5_H265_VPS_1080p60; break; }
      case 'd': case 'D': { sps = type5_H265_SPS_1080p50; pps = type5_H265_PPS_1080p50; vps = type5_H265_VPS_1080p50; break; }
      case 'e': case 'E': { sps = type5_H264_SPS_1080p48_DJIMini2; pps = type5_H264_PPS_DJIMini2; break; }
      case 'f': case 'F': { sps = type5_H264_SPS_1080p30_MavicAir; pps = type5_H264_PPS_MavicAir; break; }
      case 'g': case 'G': { sps = type5_H264_SPS_1080p25_MavicAir; pps = type5_H264_PPS_MavicAir; break; }
      case 'h': case 'H': { sps = type5_H264_SPS_720p30; pps = type5_H264_PPS_720p30; break; }
      case 'i': case 'I': { sps = type5_H264_SPS_720p24; pps = type5_H264_PPS_720p24; break; }
