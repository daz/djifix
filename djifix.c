...
static char const* versionStr = "2026-02-01";
  ...
  */
  {
    ...
    */
    while (1) {
      ...
      fprintf(stderr, "\tIf the video format was H.264, 1080p, 25fps: Type O, then the \"Return\" key.\n");

      fprintf(stderr, "\tIf the video format was H.264, 720p, 30fps: Type P, then the \"Return\" key.\n");
      fprintf(stderr, "\tIf the video format was H.264, 720p, 24fps: Type Q, then the \"Return\" key.\n");
      fprintf(stderr, " If the resulting file is unplayable by VLC or IINA, then you may have guessed the wrong format;\n");
      fprintf(stderr, " try again with another format.)\n");
      fprintf(stderr, "If you know for sure that your video format was *not* one of the ones listed above, then please read FAQ number 4 at \"https://djifix.live555.com/#faq\", and we'll try to update the software to support your video format.\n");
      do {formatCode = getchar(); } while (formatCode == '\r' && formatCode == '\n');
    ...
    switch (formatCode) {
      ...
      case 'o': case 'O': { sps = type5_H264_SPS_1080p25_MavicAir; pps = type5_H264_PPS_MavicAir; break; }
      case 'p': case 'P': { sps = type5_H264_SPS_720p30; pps = type5_H264_PPS_720p30; break; }
      case 'q': case 'Q': { sps = type5_H264_SPS_720p24; pps = type5_H264_PPS_720p24; break; }
